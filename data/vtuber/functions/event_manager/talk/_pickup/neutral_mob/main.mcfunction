...
data modify storage vtuber_data_temporaly Copy set from storage vtuber_data_database Mobs
function vtuber:event_manager/talk/_pickup/neutral_mob/loop
...
# 終了
data remove storage vtuber_data_temporaly TempList
