...
data modify storage vtuber_data_temporaly Datas.String set from storage vtuber_data_strings Strings.EndAsk[2]
...
data remove storage vtuber_data_temporaly NewWord.AggressionTxt
data remove storage vtuber_data_temporaly NewWord.LikeTxt
data modify storage vtuber_data_database Mobs append from storage vtuber_data_temporaly NewWord
scoreboard players add $vd_data_mobs_length VtuberCore 1
