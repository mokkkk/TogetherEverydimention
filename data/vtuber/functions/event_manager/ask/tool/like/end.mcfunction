...
data modify storage vtuber_data_temporaly Datas.String set from storage vtuber_data_strings Strings.EndAsk[4]
...
data remove storage vtuber_data_temporaly NewWord.ToolUseTxt
data modify storage vtuber_data_database Tools append from storage vtuber_data_temporaly NewWord
scoreboard players add $vd_data_tools_length VtuberCore 1
