...
data modify storage vtuber_data_temporaly Datas.String set from storage vtuber_data_strings Strings.EndAsk[3]
...
data remove storage vtuber_data_temporaly NewWord.HealthTxt
data remove storage vtuber_data_temporaly NewWord.LikeTxt
data modify storage vtuber_data_database Foods append from storage vtuber_data_temporaly NewWord
scoreboard players add $vd_data_foods_length VtuberCore 1
